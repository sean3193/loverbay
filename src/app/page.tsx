...
const GALLERY_LABELS: Record<Lang, Record<string, string>> = {
  zh: { 'gallery.label1': '海岸全景', 'gallery.label2': '海風慢活露台', 'gallery.label3': '海風慢活露台', 'gallery.label4': '交流交誼廳', 'gallery.label5': '三樓·全景聽海舒壓空間', 'gallery.label6': '二樓·多功能共享中島空間', 'gallery.label7': '一樓·獨立休憩場域', 'gallery.label8': '一樓·獨立休憩場域', 'gallery.label9': '獨立衛浴場域', 'gallery.label10': '三樓·全景聽海舒壓空間' },
  en: { 'gallery.label1': 'Coastal Panorama', 'gallery.label2': 'Ocean Breeze Terrace', 'gallery.label3': 'Ocean Breeze Terrace', 'gallery.label4': 'Social Lounge', 'gallery.label5': '3F · Panoramic Seaview Space', 'gallery.label6': '2F · Shared Island Kitchen', 'gallery.label7': '1F · Independent Retreat', 'gallery.label8': '1F · Independent Retreat', 'gallery.label9': 'Private Bath Suite', 'gallery.label10': '3F · Panoramic Seaview Space' },
  ja: { 'gallery.label1': '海岸パノラマ', 'gallery.label2': '潮風テラス', 'gallery.label3': '潮風テラス', 'gallery.label4': 'ラウンジスペース', 'gallery.label5': '3F・全景シービュースペース', 'gallery.label6': '2F・共有アイランドキッチン', 'gallery.label7': '1F・独立休憩エリア', 'gallery.label8': '1F・独立休憩エリア', 'gallery.label9': 'プライベートバス', 'gallery.label10': '3F・全景シービュースペース' },
  ko: { 'gallery.label1': '해안 파노라마', 'gallery.label2': '해풍 테라스', 'gallery.label3': '해풍 테라스', 'gallery.label4': '교류 라운지', 'gallery.label5': '3F·파노라마 오션뷰 공간', 'gallery.label6': '2F·공유 아일랜드 키친', 'gallery.label7': '1F·독립 휴식 공간', 'gallery.label8': '1F·독립 휴식 공간', 'gallery.label9': '전용 욕실 공간', 'gallery.label10': '3F·파노라마 오션뷰 공간' },
}
