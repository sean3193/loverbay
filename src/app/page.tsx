...
const T: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    's3.n': '豆腐岬', 's3.d': '清澈碧藍的浮潛秘境，珊瑚礁魚群悠游，夏日玩水首選', 's3.dist': '車程約 2 分鐘・步行約 11 分鐘',
    's4.n': '外澳衝浪灘', 's4.d': '宜蘭最知名衝浪勝地，浪花拍打、遠眺龜山島美景', 's4.dist': '約 40 分鐘車程',
    's5.n': '礁溪溫泉', 's5.d': '全台少見平地溫泉，露天泡湯放鬆身心的最佳選擇', 's5.dist': '約 30 分鐘車程',
    's6.n': '羅東夜市', 's6.d': '宜蘭夜間美食天堂，臭豆腐、蔥油餅、烤鴨應有盡有', 's6.dist': '車程約 29 分鐘',
    's7.n': '南方澳觀景台', 's7.d': '居高臨下俯瞰南方澳漁港與太平洋，夕陽時分景色醉人，是南方澳必訪打卡點', 's7.dist': '車程約 34 分鐘・步行約 10 分鐘',
    's8.n': '七星嶺步道', 's8.d': '蘇澳最美健行步道，沿途七個觀景平台可遠眺龜山島、蘭陽平原與太平洋', 's8.dist': '約 10 分鐘車程',
    's9.n': '賊仔澳玻璃海灘', 's9.d': '海浪將碎玻璃磨成圓潤砂礫，陽光下閃閃發光，隱藏版秘境海灘', 's9.dist': '車程約 1 分鐘・步行約 5 分鐘',
    's10.n': '南方澳魚市場', 's10.d': '產地直送現流海鮮，感受漁港最道地的活力與人情味', 's10.dist': '車程約 7 分鐘・步行約 29 分鐘',
    'tr.title': '怎麼來找我們',
  ...
  en: {
    ...
    's3.n': 'Doufu Cape', 's3.d': 'Crystal-clear snorkeling cove with colorful coral reef fish', 's3.dist': '~2 min drive / 11 min walk',
    's4.n': 'Waiao Surf Beach', 's4.d': 'Yilan\'s top surf spot with a stunning view of Guishan Island', 's4.dist': '~40 min drive',
    's5.n': 'Jiaoxi Hot Springs', 's5.d': 'Rare flatland hot springs — perfect for unwinding after a day out', 's5.dist': '~30 min drive',
    's6.n': 'Luodong Night Market', 's6.d': 'Yilan\'s most famous night market packed with street food delights', 's6.dist': '~29 min drive',
    's7.n': 'Nanfang\'ao Observation Deck', 's7.d': 'Panoramic overlook of the fishing port and Pacific Ocean — magical at golden hour', 's7.dist': '~34 min drive / 10 min walk',
    ...
    's9.n': 'Zeiziao Glass Beach', 's9.d': 'Waves have polished sea glass into smooth, glittering sand — a hidden gem beach', 's9.dist': '~1 min drive / 5 min walk',
    's10.n': 'Nanfang\'ao Fish Market', 's10.d': 'Fresh-off-the-boat seafood straight from the harbor — taste the local fishing life', 's10.dist': '~7 min drive / 29 min walk',
  ...
  ja: {
    ...
    's3.n': '豆腐岬', 's3.d': '透明度の高いシュノーケリングスポット、カラフルな熱帯魚に出会えます', 's3.dist': '車で約2分・徒歩約11分',
    's4.n': '外澳サーフビーチ', 's4.d': '宜蘭で最も人気のサーフスポット、亀山島の絶景も楽しめます', 's4.dist': '車で約40分',
    's5.n': '礁渓温泉', 's5.d': '平地では珍しい温泉地、露天風呂でゆったりリフレッシュ', 's5.dist': '車で約30分',
    's6.n': '羅東ナイトマーケット', 's6.d': '宜蘭を代表するナイトマーケット、地元グルメが勢ぞろい', 's6.dist': '車で約29分',
    's7.n': '南方澳展望台', 's7.d': '漁港と太平洋を一望できる展望台。夕暮れ時は息をのむ絶景が広がります', 's7.dist': '車で約34分・徒歩約10分',
    's8.n': '七星嶺ハイキングコース', 's8.d': '7つの展望スポットから亀山島・蘭陽平原・太平洋を見渡す蘇澳随一のトレイル', 's8.dist': '車で約10分',
    's9.n': '賊仔澳ガラスビーチ', 's9.d': '波に磨かれたガラス片が砂浜できらきら輝く隠れた絶景スポット', 's9.dist': '車で約1分・徒歩約5分',
    's10.n': '南方澳魚市場', 's10.d': '港直送の新鮮な海の幸、漁港ならではの活気を体感できます', 's10.dist': '車で約7分・徒歩約29分',
    'tr.title': 'アクセス方法',
  ...
  ko: {
    ...
    's3.n': '더우푸자 (두부곶)', 's3.d': '산호초와 열대어가 가득한 투명한 스노클링 명소', 's3.dist': '차로 약 2분・도보 약 11분',
    's4.n': '와이아오 서핑 해변', 's4.d': '이란 최고의 서핑 명소, 구이산섬 전망이 아름다운 해변', 's4.dist': '차로 약 40분',
    's5.n': '자오시 온천', 's5.d': '대만에서 보기 드문 평지 온천, 야외 탕에서 여유롭게 휴식', 's5.dist': '차로 약 30분',
    's6.n': '뤄둥 야시장', 's6.d': '이란 최대 야시장, 현지 길거리 음식이 가득한 미식 천국', 's6.dist': '차로 약 29분',
    's7.n': '난팡아오 전망대', 's7.d': '어항과 태평양을 내려다보는 전망대. 황금빛 석양이 물드는 시간이 특히 아름답습니다', 's7.dist': '차로 약 34분・도보 약 10분',
    's8.n': '치싱링 하이킹 코스', 's8.d': '7개의 전망 포인트에서 구이산섬, 란양평원, 태평양을 한눈에 볼 수 있는 쑤아오 최고의 트레일', 's8.dist': '차로 약 10분',
    's9.n': '제이짜오 글래스비치', 's9.d': '파도에 깎인 유리 조각이 모래사장에서 반짝이는 숨은 비밀 해변', 's9.dist': '차로 약 1분・도보 약 5분',
    's10.n': '난팡아오 어시장', 's10.d': '항구에서 바로 잡아온 신선한 해산물, 생생한 어항의 활기를 느낄 수 있는 곳', 's10.dist': '차로 약 7분・도보 약 29분',
    'tr.title': '오시는 방법',
...
const GALLERY = [
  ...
  { src: `${BASE}/photos/loverbay-sky.jpg`,   alt: '情人灣藍天', label: 'gallery.label11', cls: '' },
...
const GALLERY_LABELS: Record<Lang, Record<string, string>> = {
  zh: { 'gallery.label1': '海岸全景', 'gallery.label2': '海風慢活露台', 'gallery.label3': '海風慢活露台', 'gallery.label4': '交流交誼廳', 'gallery.label5': '三樓·全景聽海舒壓空間', 'gallery.label6': '二樓·多功能共享中島空間', 'gallery.label7': '一樓·獨立休憩空間', 'gallery.label8': '一樓·獨立休憩空間', 'gallery.label9': '獨立衛浴空間', 'gallery.label10': '二樓·獨立休憩空間', 'gallery.label11': '情人灣藍天' },
  en: { 'gallery.label1': 'Coastal Panorama', 'gallery.label2': 'Ocean Breeze Terrace', 'gallery.label3': 'Ocean Breeze Terrace', 'gallery.label4': 'Social Lounge', 'gallery.label5': '3F · Panoramic Seaview Space', 'gallery.label6': '2F · Shared Island Kitchen', 'gallery.label7': '1F · Independent Retreat', 'gallery.label8': '1F · Independent Retreat', 'gallery.label9': 'Private Bath Suite', 'gallery.label10': '2F · Independent Retreat', 'gallery.label11': 'Loverbay Blue Sky' },
  ja: { 'gallery.label1': '海岸パノラマ', 'gallery.label2': '潮風テラス', 'gallery.label3': '潮風テラス', 'gallery.label4': 'ラウンジスペース', 'gallery.label5': '3F・全景シービュースペース', 'gallery.label6': '2F・共有アイランドキッチン', 'gallery.label7': '1F・独立休憩エリア', 'gallery.label8': '1F・独立休憩エリア', 'gallery.label9': 'プライベートバス', 'gallery.label10': '2F・独立休憩エリア', 'gallery.label11': '恋人湾の青空' },
  ko: { 'gallery.label1': '해안 파노라마', 'gallery.label2': '해풍 테라스', 'gallery.label3': '해풍 테라스', 'gallery.label4': '교류 라운지', 'gallery.label5': '3F·파노라마 오션뷰 공간', 'gallery.label6': '2F·공유 아일랜드 키친', 'gallery.label7': '1F·독립 휴식 공간', 'gallery.label8': '1F·독립 휴식 공간', 'gallery.label9': '전용 욕실 공간', 'gallery.label10': '2F·독립 휴식 공간', 'gallery.label11': '러버베이 푸른 하늘' },
}
