...
const T: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'tr.title': '怎麼來找我們',
    't1.n': '自駕', 't1.d': '走國道 5 號至終點「蘇澳交流道」下，循台9丙線往南方澳方向，過跨海大橋後依 Google Maps 導航「宜蘭縣蘇澳鎮造船路102號」即可抵達。提供免費停車位。',
  ...
  en: {
    ...
    't1.n': 'Self-Drive', 't1.d': 'Take National Freeway 5 to the last exit "Suao Interchange", follow Rt. 9C toward Nanfang\'ao, cross the Nanfang\'ao Bridge, then navigate to "No.102, Zaochuan Rd., Su-ao". Free parking available.',
  ...
  ja: {
    ...
    'tr.title': 'アクセス方法',
    't1.n': '自家用車', 't1.d': '国道5号の終点「蘇澳IC」を降り、台9丙線を南方澳方面へ。南方澳大橋を渡り「造船路102号」へナビ設定。無料駐車場完備。',
  ...
  ko: {
    ...
    'tr.title': '오시는 방법',
    't1.n': '자가용', 't1.d': '국도 5호선 종점 「쑤아오 IC」에서 내려 대만 9丙선을 따라 난팡아오 방면으로 진행. 난팡아오 대교를 건너 「자오촨로 102호」로 내비게이션. 무료 주차 가능.',
...
const GALLERY_LABELS: Record<Lang, Record<string, string>> = {
  zh: { 'gallery.label1': '海岸全景', 'gallery.label2': '海風慢活露台', 'gallery.label3': '海風慢活露台', 'gallery.label4': '交流交誼廳', 'gallery.label5': '三樓·全景聽海舒壓空間', 'gallery.label6': '二樓·多功能共享中島空間', 'gallery.label7': '一樓·獨立休憩場域', 'gallery.label8': '一樓·獨立休憩場域', 'gallery.label9': '獨立衛浴場域', 'gallery.label10': '二樓·獨立休憩空間' },
