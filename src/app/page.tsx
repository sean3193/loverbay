...
const T: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    's4.n': '外澳衝浪灘', 's4.d': '宜蘭最知名衝浪勝地，浪花拍打、遠眺龜山島美景', 's4.dist': '車程約 40 分鐘-1 小時 10 分鐘',
    's5.n': '礁溪溫泉', 's5.d': '全台少見平地溫泉，露天泡湯放鬆身心的最佳選擇', 's5.dist': '車程約 30-50 分鐘',
    's6.n': '羅東夜市', 's6.d': '宜蘭夜間美食天堂，臭豆腐、蔥油餅、烤鴨應有盡有', 's6.dist': '車程約 30-50 分鐘',
    's7.n': '南方澳觀景台', 's7.d': '居高臨下俯瞰南方澳漁港與太平洋，夕陽時分景色醉人，是南方澳必訪打卡點', 's7.dist': '車程約 30-40 分鐘',
  ...
  en: {
    ...
    's4.n': 'Waiao Surf Beach', 's4.d': 'Yilan\'s top surf spot with a stunning view of Guishan Island', 's4.dist': '~40 min - 1 hr 10 min drive',
    's5.n': 'Jiaoxi Hot Springs', 's5.d': 'Rare flatland hot springs — perfect for unwinding after a day out', 's5.dist': '~30-50 min drive',
    's6.n': 'Luodong Night Market', 's6.d': 'Yilan\'s most famous night market packed with street food delights', 's6.dist': '~30-50 min drive',
    's7.n': 'Nanfang\'ao Observation Deck', 's7.d': 'Panoramic overlook of the fishing port and Pacific Ocean — magical at golden hour', 's7.dist': '~30-40 min drive',
  ...
  ja: {
    ...
    's4.n': '外澳サーフビーチ', 's4.d': '宜蘭で最も人気のサーフスポット、亀山島の絶景も楽しめます', 's4.dist': '車で約40分〜1時間10分',
    's5.n': '礁渓温泉', 's5.d': '平地では珍しい温泉地、露天風呂でゆったりリフレッシュ', 's5.dist': '車で約30〜50分',
    's6.n': '羅東ナイトマーケット', 's6.d': '宜蘭を代表するナイトマーケット、地元グルメが勢ぞろい', 's6.dist': '車で約30〜50分',
    's7.n': '南方澳展望台', 's7.d': '漁港と太平洋を一望できる展望台。夕暮れ時は息をのむ絶景が広がります', 's7.dist': '車で約30〜40分',
  ...
  ko: {
    ...
    's4.n': '와이아오 서핑 해변', 's4.d': '이란 최고의 서핑 명소, 구이산섬 전망이 아름다운 해변', 's4.dist': '차로 약 40분~1시간 10분',
    's5.n': '자오시 온천', 's5.d': '대만에서 보기 드문 평지 온천, 야외 탕에서 여유롭게 휴식', 's5.dist': '차로 약 30~50분',
    's6.n': '뤄둥 야시장', 's6.d': '이란 최대 야시장, 현지 길거리 음식이 가득한 미식 천국', 's6.dist': '차로 약 30~50분',
    's7.n': '난팡아오 전망대', 's7.d': '어항과 태평양을 내려다보는 전망대. 황금빛 석양이 물드는 시간이 특히 아름답습니다', 's7.dist': '차로 약 30~40분',
