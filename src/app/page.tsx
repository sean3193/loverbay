...
const T: Record<Lang, Record<string, string>> = {
  zh: {
    'nav.about': '品牌介紹', 'nav.spaces': '空間', 'nav.pricing': '價格',
    'nav.booking': '預約', 'nav.transport': '交通',
    'hero.eyebrow': '宜蘭海岸第一排 · 一次只接待一組VIP貴賓',
    'hero.title': '灣灣拾光',
    'hero.sub': '在最靠近海浪的地方，收藏屬於你們的時光',
    'hero.book': '立即預約', 'hero.line': '加入 LINE 聯繫', 'hero.scroll': '向下探索',
    ...
    'f3.t': '全日包棟', 'f3.d': '整棟獨享，從入住到退房全程專屬',
    ...
    'space.name': '日租包棟', 'space.cta': '立即預約',
    'space.sdesc': '整棟獨享，含主臥、廚房、客廳、戶外平台，全程無其他房客',
    ...
    'f.in': '入住日期', 'f.out': '退房日期',
    'f.guests': '入住人數', 'f.guests.ph': '請輸入人數',
...
══════════════════════════════════════════ */
const GALLERY = [
  { src: '/photos/海岸空拍.webp',     alt: '海岸全景',   label: 'gallery.label1', cls: 'gallery-big' },
  { src: '/photos/海景陽台夜.webp',   alt: '夜景陽台',   label: 'gallery.label2', cls: '' },
  { src: '/photos/海景陽台4.jpg',     alt: '戶外陽台',   label: 'gallery.label3', cls: 'gallery-wide' },
  { src: '/photos/海景內客廳.jpg',    alt: '海景客廳',   label: 'gallery.label4', cls: '' },
  { src: '/photos/海景床.webp',       alt: '海景臥室',   label: 'gallery.label5', cls: '' },
  { src: '/photos/廚房瓦斯爐.jpg',   alt: '全套廚房',   label: 'gallery.label6', cls: '' },
]
const GALLERY_LABELS: Record<Lang, Record<string, string>> = {
  ...
  en: { 'gallery.label1': 'Coastal View', 'gallery.label2': 'Night Terrace', 'gallery.label3': 'Outdoor Deck', 'gallery.label4': 'Ocean Living Room', 'gallery.label5': 'Ocean Bedroom', 'gallery.label6': 'Full Kitchen' },
  ja: { 'gallery.label1': '海岸パノラマ', 'gallery.label2': 'ナイトテラス', 'gallery.label3': 'アウトドアデッキ', 'gallery.label4': 'オーシャンリビング', 'gallery.label5': 'オーシャンベッドルーム', 'gallery.label6': 'フルキッチン' },
  ko: { 'gallery.label1': '해안 전경', 'gallery.label2': '야경 테라스', 'gallery.label3': '야외 데크', 'gallery.label4': '오션뷰 거실', 'gallery.label5': '오션뷰 침실', 'gallery.label6': '풀 주방' },
}
      ...
      <section id="about" className="py-24 px-[5%]">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mt-10">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl h-96 relative">
            <Image src="/photos/海景陽台2.webp" alt="灣灣拾光海景" fill className="object-cover" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-lg">
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:-translate-y-1 transition-transform">
            <div className="relative h-56">
              <Image src="/photos/海景陽台4.jpg" alt="日租包棟" fill className="object-cover" />
